...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/js_r/jPlayer/jplayer.flat.css') }}" type="text/css" />
...
<body>
    ...
    <script src="{{ asset('css/js_r/jquery.min.js') }}"></script>
    <script src="{{ asset('css/js_r/bootstrap.js') }}"></script>
    <script src="{{ asset('css/js_r/app.js') }}"></script>  
    <script src="{{ asset('css/js_r/slimscroll/jquery.slimscroll.min.js') }}"></script>
    <script src="{{ asset('css/js_r/app.plugin.js') }}"></script>
    <script type="text/javascript" src="{{ asset('css/js_r/jPlayer/jquery.jplayer.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('css/js_r/jPlayer/add-on/jplayer.playlist.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('css/js_r/jPlayer/demo.js') }}"></script>
</body>
</html>